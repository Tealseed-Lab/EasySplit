...
const (
	...
	OpenAIChatReceiptText                 = `Make a list of every item in order, with its price (you can omit the items that are free). They receipt may use different terms, such as "Service Fee / Svg Chg / 服务费" instead of "Service Charge / tax / 税" for GST, "折扣" for "Discount", "小计" for Subtotal, "合计" for Total, please convert them "Service Charge", "GST", "Discount" should always exist, but can have value 0.`
